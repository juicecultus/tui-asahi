# ~/.bashrc — MacBook Air M2 Fedora Asahi Remix 42 Matrix Theme
...
alias nf='fastfetch'
alias sys='inxi -Fxz'
alias temps='cat /sys/class/hwmon/hwmon1/temp*_input 2>/dev/null | while read t; do echo "$((t/1000))°C"; done'
...
alias net='sudo iftop -i $(ip route show default 2>/dev/null | awk "{print \$5; exit}")'
...
# --- Aliases: MacBook Air brightness/volume (console) ---
alias bri+='brightnessctl -d apple-panel-bl s +10%'
alias bri-='brightnessctl -d apple-panel-bl s 10%-'
alias kbd+='brightnessctl -d kbd_backlight s +25'
alias kbd-='brightnessctl -d kbd_backlight s 25-'
...
if command -v fzf &>/dev/null; then
    ...
    # Load fzf keybindings (Fedora path)
